...
import 'package:taxiapprus/datamodels/directiondetails.dart';
import 'package:taxiapprus/datamodels/nearbydriver.dart';
import 'package:taxiapprus/dataprovider/appdata.dart';
import 'package:taxiapprus/globalvariable.dart';
import 'package:taxiapprus/helpers/firehelper.dart';
import 'package:taxiapprus/helpers/helpermethods.dart';
import 'package:taxiapprus/rideVaribles.dart';
import 'package:taxiapprus/screens/searchpage.dart';
import 'package:taxiapprus/styles/styles.dart';
import 'package:taxiapprus/widgets/BrandDivier.dart';
import 'package:taxiapprus/widgets/CollectPaymentDialog.dart';
import 'package:taxiapprus/widgets/NoDriverDialog.dart';
          ...
          child: ListView(
            ...
            children: <Widget>[
                  ...
                  child: Row(
                    children: <Widget>[
                      ...
                      Column(
                        ...
                        children: <Widget>[
                          Text('Пользователь', style: TextStyle(fontSize: 20, fontFamily: 'Brand-Bold'),),
                          SizedBox(height: 5,),
              ...
              ListTile(
                ...
                title: Text('Акции', style: kDrawerItemStyle,),
              ),

              ListTile(
                leading: Icon(OMIcons.creditCard),
                title: Text('Способ оплаты', style: kDrawerItemStyle,),
              ),

              ListTile(
                leading: Icon(OMIcons.history),
                title: Text('История поездки', style: kDrawerItemStyle,),
              ),

              ListTile(
                leading: Icon(OMIcons.contactSupport),
                title: Text('Поддежка', style: kDrawerItemStyle,),
              ),

              ListTile(
                leading: Icon(OMIcons.info),
                title: Text('О нас', style: kDrawerItemStyle,),
              ),
              ...
              child: Container(
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                      SizedBox(height: 5,),
                      Text('добро пожаловать!', style: TextStyle(fontSize: 10),),
                      Text('Куда едем?', style: TextStyle(fontSize: 18, fontFamily: 'Brand-Bold'),),
                          ...
                          child: Row(
                            children: <Widget>[
                              ...
                              Column(
                                crossAxisAlignment: CrossAxisAlignment.start,
                                children: <Widget>[
                                  Text('Такси', style: TextStyle(fontSize: 18, fontFamily: 'Brand-Bold'),),
